...
On the last page, you will be shown a summary of their choices.
...
- Include all AI prompts you use (for code, design, or copy) in a file named `AI_PROMPTS.txt` 
- Include a `README.md` file outlining any setup instructions for your code

## Submission
You can either upload your solution to Github and share the link with us, or send a zip file of your code (excluding any `node_modules`) to [jack.stevens@news.co.uk](mailto:jack.stevens@news.co.uk)
